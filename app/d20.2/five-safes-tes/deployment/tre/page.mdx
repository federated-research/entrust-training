...
- [Funnel](https://docs.federated-analytics.ac.uk/five_safes_tes/reference_implementation/TES/install_funnel) as a Five Safes TES Backend
...
- the **TES Backend** and **MinIO** - as described in [this guide](https://docs.federated-analytics.ac.uk/five_safes_tes/reference_implementation/TES/install_funnel)
